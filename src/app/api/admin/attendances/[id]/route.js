...
import { updateAttendanceByAdmin } from "@/server/repositories/attendance-repository";
...
export async function PATCH(request, { params }) {
  ...
  const parsed = attendanceAdminUpdateSchema.safeParse(body);
  ...
  try {
    ...
    const attendance = await updateAttendanceByAdmin(id, parsed.data);
